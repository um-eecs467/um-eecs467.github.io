...
| Resource | Link |
|----------|------|
| **Piazza** (Q&A, announcements) | [piazza.com/umich/winter2026/eecs467wn26](https://piazza.com/umich/winter2026/eecs467wn26) |
| **Google Drive** (notes, slides) | [EECS467 WN26 Shared](https://drive.google.com/drive/folders/15JTWDcFC9rMoDbFQ5EplBO0OS1fgCsLn?usp=drive_link) |
| **GitLab** (projects & tutorials) | [gitlab.eecs.umich.edu/eecs467-wn26](https://gitlab.eecs.umich.edu/eecs467-wn26) |
| **Canvas** (submissions & grades) | [canvas.it.umich.edu](https://canvas.it.umich.edu/) |
| **PrairieLearn** (HW & quizzes) | [us.prairielearn.com](https://us.prairielearn.com/) |
| **Office Hours Calendar** | [Schedule page](/w26/schedule/) |
| **Lecture Videos** | [YouTube Playlist](https://youtube.com/playlist?list=PLtT6bWPnaAa34WmbPgGVW_zAu4Wjwx19I&si=8hDz1fVUVaUZ_p61) |
| **MBot Documentation** | [mbot.robotics.umich.edu](https://mbot.robotics.umich.edu/docs/hardware/classic/) |
...
**Warning:** Software development in **C/C++ and Python** is a major part of this course. Prior programming experience in C or Python (or a comparable language) is required. You may also find the [ROS2 documentation](https://docs.ros.org/en/jazzy/index.html) helpful.

## Collaboration Policy

Individual assignments must be submitted independently. For group assignments, each team must submit wholly original work. Teams are encouraged to discuss ideas but must produce independent write-ups and code. All team members are expected to understand every aspect of the team's work. See the [full syllabus on Google Drive](https://drive.google.com/drive/folders/15JTWDcFC9rMoDbFQ5EplBO0OS1fgCsLn?usp=drive_link) for the full collaboration policy statement requirements.
...
- **Disability Accommodations:** Contact [SSD](http://ssd.umich.edu) (734-763-3000) for accommodations.
- **Diversity:** All members are expected to contribute to a respectful, inclusive environment.
- **Student Well-Being:** Resources available at [wellbeing.studentlife.umich.edu](https://wellbeing.studentlife.umich.edu/).
